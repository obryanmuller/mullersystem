...
export default function Sidebar() {
  const pathname = usePathname(); // Pega a rota atual (ex: "/produtos")
      ...
      <nav className="flex-1 p-4">
        <ul>
          <li className="mb-2">
            <Link 
              href="/main/dashboard" 
              className={`${linkStyle} ${pathname === '/' ? activeLinkStyle : inactiveLinkStyle}`}
            >
          ...
          <li className="mb-2">
            <Link 
              href="/main/produtos" 
              className={`${linkStyle} ${pathname === '/produtos' ? activeLinkStyle : inactiveLinkStyle}`}
            >
          ...
          <li className="mb-2">
            <Link 
              href="/main/vendas" 
              className={`${linkStyle} ${pathname === '/vendas' ? activeLinkStyle : inactiveLinkStyle}`}
            >
