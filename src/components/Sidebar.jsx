  ...
  return (
    <aside className="w-64 h-screen bg-brand-dark text-white flex flex-col">
      <div className="p-6 flex justify-center items-center border-b border-gray-700">
        <Image
          src="/Logo.jpg" // Usando a logo que você enviou
      ...
      <nav className="flex-1 p-4">
        <ul>
          <li className="mb-2">
            <Link href="/" className="flex items-center p-3 rounded-lg hover:bg-brand-green hover:text-white transition-colors">
              {/* Efeito hover agora usa o verde da marca */}
          ...
          <li className="mb-2">
            <Link href="/produtos" className="flex items-center p-3 rounded-lg bg-brand-green text-white font-semibold transition-colors">
              {/* Link ativo continua verde */}
              <Icon path="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7l8 4" />
              Estoque
            </Link>
          </li>
          <li className="mb-2">
            <Link href="/vendas" className="flex items-center p-3 rounded-lg hover:bg-brand-green hover:text-white transition-colors">
              {/* Efeito hover agora usa o verde da marca */}
