...
// Tipos
type Cliente = { id: number; nome: string; email: string; telefone: string; status: string; totalCompras: number; };
...
const mockClientes: Cliente[] = [
    { id: 1, nome: 'João da Silva', email: 'joao.silva@email.com', telefone: '(11) 98765-4321', status: 'Ativo', totalCompras: 1250.50 },
    { id: 2, nome: 'Maria Oliveira', email: 'maria.o@email.com', telefone: '(21) 91234-5678', status: 'Ativo', totalCompras: 3480.00 },
    { id: 3, nome: 'Carlos Pereira', email: 'carlos.pereira@email.com', telefone: '(31) 99999-8888', status: 'Inativo', totalCompras: 500.00 },
    { id: 4, nome: 'Ana Costa', email: 'ana.costa@email.com', telefone: '(41) 98888-7777', status: 'Ativo', totalCompras: 780.25 },
    { id: 5, nome: 'Pedro Martins', email: 'pedro.m@email.com', telefone: '(51) 91111-2222', status: 'Ativo', totalCompras: 2150.00 },
    { id: 6, nome: 'Juliana Ferreira', email: 'juliana.f@email.com', telefone: '(61) 92222-3333', status: 'Ativo', totalCompras: 990.75 },
];
